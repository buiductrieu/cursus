        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SupportHotline = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstructorCertificates", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateArchive = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchivedTransactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArchivedTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalWithdrawn = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InstructorInfoId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayoutRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PayoutRequests_InstructorInfos_InstructorInfoId",
                        column: x => x.InstructorInfoId,
                        principalTable: "InstructorInfos",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    TrackedTransactionId = table.Column<int>(type: "int", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountChanged = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StepComments_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrackingProgresses_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TrackingProgresses_CourseProgresses_ProgressId",
                        column: x => x.ProgressId,
                        principalTable: "CourseProgresses",
                        principalColumn: "ProgressId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrackingProgresses_Steps_StepId",
                        column: x => x.StepId,
                        principalTable: "Steps",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "24365deb-5d7c-42e3-bf55-103bd09a34ed", null, "User", "USER" },
                    { "8771b583-5ed0-4d1e-9c75-4c5259adce15", null, "Instructor", "INSTRUCTOR" },
                    { "f70eaa08-7ab1-42b7-b2e9-bc9289a13d79", null, "Admin", "ADMIN" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArchivedTransactions_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IDX_InstructorInfo_UserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IDX_Orders_Status1_DateCreated",
                table: "Order",
                column: "DateCreated",
                filter: "[Status] = 1")
                .Annotation("SqlServer:Include", new[] { "PaidAmount", "CartId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PayoutRequests_InstructorInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrackingProgresses_ProgressId",
                table: "TrackingProgresses",
                column: "ProgressId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackingProgresses_StepId",
                table: "TrackingProgresses",
                column: "StepId");

            migrationBuilder.CreateIndex(
                name: "IX_TrackingProgresses_UserId",
                table: "TrackingProgresses",
                column: "UserId");
